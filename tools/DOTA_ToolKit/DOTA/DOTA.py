...
import numpy as np
import tools.DOTA_ToolKit.dota_utils.dota_utils as util
...
class DOTA:
    ...
    def loadAnns(self, catNms=[], imgId = None, difficult=None):
        ...
        if imgId == None:
            objects = []
            for id, cat_anno in self.ImgToAnns.items():
                objects.extend(cat_anno)
        else:
...
#     examplesplit = DOTA('/home/ai-i-hanmingfei/datasets/ODAI-ICPR/val')
